...
const Navbar = () => {
  return (
    <header className="z-50 sticky w-[70%] mx-auto top-0 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="flex h-14 max-w-screen-2xl items-center mx-auto px-4">
